                                         ...
                                         child: Container(
                                           ...
                                           decoration: BoxDecoration(
                                               ...
                                               image: DecorationImage(
                                                   image:NetworkImage(state.cartData[index].image)
                                         ...
                                         child: Column(
                                           ...
                                           children: [
                                             Row(
                                               ...
                                               children: [
                                                 Text(state.cartData[index].name,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                                 Icon(Icons.delete_outlined,color: Colors.deepOrangeAccent,)
                                               ],
                                             ),
                                             Text(state.cartData[index].name,style: TextStyle(color: Colors.grey,fontSize: 14),),
                                             Row(
                                               mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                               children: [
                                                 Text(state.cartData[index].price,style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold)),
                                                 Row(
                                                   children: [
                                                     Container(
                                                       height: 30,
